...
ggplot(summary_data, aes(x = timepoint, y = mean_watt))+
  geom_line() +
  geom_point() +
  geom_errorbar(aes(ymin = mean_watt - sd_watt, ymax = mean_watt + sd_watt),
                width = 0.2) +
  labs(
    title = "Gjennomsnittlig makasimal watt med standardavvik",
    x = "Tidspunkt",
    y = "Watt"
  ) +
  theme_minimal()
